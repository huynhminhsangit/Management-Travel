...
<tr><td style="font-size:28px; color: darkred"><a href="index.php">Admin Panel<a/></td></tr>

<?php if($_SESSION["usertype"]=="Admin")
{?>
<tr><td><strong style="color: darkred">USER</strong></td></tr>
...
<?php }?>
<!--   CATEGORY  -->
<tr><td><strong style="color: darkred">CATEGORY</strong></td></tr>
<?php if($_SESSION["usertype"]=="Admin")
{?>
...
<!-- SUBCATEGORY -->
<tr><td><strong style="color: darkred">SUBCATEGORY</strong></td></tr>
<?php if($_SESSION["usertype"]=="Admin")
{?>
...
<?php if($_SESSION["usertype"]=="Admin")
{?>
<tr><td><strong style="color: darkred">EMPLOYEES</strong></td></tr>
<tr><td><a href="addemployees.php">Add Employees</a></td></tr>
<tr><td><a href="#">Update Employees</a></td></tr>
<tr><td><a href="deleteemployees.php">Delete Employees</a></td></tr>
<?php }?>

<!-- HOTEL -->    
<tr><td><strong style="color: darkred">HOTEL</strong></td></tr>   
<?php if($_SESSION["usertype"]=="Admin")
{?>
<tr><td><a href="#">Add Hotel</a></td></tr>
<tr><td><a href="#">Update Hotel</a></td></tr>
<tr><td><a href="#">Delete Hotel</a></td></tr>
<?php }?>    
    
<!-- PACKAGE -->     
<tr><td><strong style="color: darkred">PACKAGE</strong></td></tr>  
<?php if($_SESSION["usertype"]=="Admin")
{?>
...
<!-- ADVERTISEMENT -->        
<tr><td><strong style="color: darkred">ADVERTISEMENT</strong></td></tr>   
<?php if($_SESSION["usertype"]=="Admin")
{?>
...
<!-- ENQUIRY -->    
<tr><td><strong style="color: darkred">ENQUIRY</strong></td></tr>       
