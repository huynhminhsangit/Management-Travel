...
{
	$cn=makeconnection();
	$s="select * from users where username='" . $_POST["username"] . "' and pwd='" . $_POST["pwd"] ."'";
    ...
    <tr>
        ...
        <td class="lefttxt">
            <table border="0" width="100px" height="200px">
                <tr>
                    <td>User Name</td>
                    <td><input type="text" name="username" required pattern="[a-zA-z _]{1,50}" title"Please Enter Only Characters between 1 to 50 for User Name" /></td>
                </tr>
                <tr>
                    <td class="lefttxt">Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td><input type="password" name="pwd" required pattern="[a-zA-z0-9]{1,10}" title"Please Enter Only Characters between 1 to 10 for Password" /></td>
                </tr>
            </table>
    <tr>
        <td></td>
        <td align="center" ><button class="btn btn-success" type="submit" name="sbmt" />LOGIN</button></td>
    </tr>
    </table>
</form>
</div>
